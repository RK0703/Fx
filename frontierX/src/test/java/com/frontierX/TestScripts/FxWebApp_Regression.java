...
public class FxWebApp_Regression extends FxSettings 
{	
		...
		{		
			...
			for (Map.Entry<String,String> FxFit : FitFiles.entrySet())
			{
					...
					//	justSleepFor(6);
						...
						justSleepFor(3);
						Assert.assertTrue(FxUtilities.isFxFileDownloaded(FxFit.getValue())," Fit File "+FxFit.getValue()+ " of size "+FxFit.getKey()+" downloaded");	
			}
		 }
		/*
		 * 
