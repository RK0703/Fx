...
import com.frontierX.Utilities.FxEnums.FxParms;
...
public class JsonIO 
{
	...
	public void SetJsonValue(String HRVal , String HRUnit , String duriation) throws IOException
	{
		fxParams = new FXParameters(HRVal,HRUnit,duriation);
